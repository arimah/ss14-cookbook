      ...
      <FocusTrap onPointerDownOutside={onClose}>
        <section className='dialog privacy' ref={ref} tabIndex={-1}>
          ...
          <div className='privacy_text thin-scroll'>
            ...
            <p>Anything you save through the web app (favourite recipes, menus, etc.) is stored on your device and is not transferred anywhere else at any point. It is not visible to me in any way.</p>
            <p>
